...
export function useGetGlobalMessages() {
	...
	const getGlobalMessages = () => {
		return fetch(`${process.env.REACT_APP_API_URL}/api/messages/global`, requestOptions)
			.then(handleResponse)
			.catch(() =>
...
export function useGetConversations() {
	...
	const getConversations = () => {
		return fetch(`${process.env.REACT_APP_API_URL}/api/messages/conversations`, requestOptions)
			.then(handleResponse)
			.catch(() =>
...
export function useGetConversationMessages() {
	...
	const getConversationMessages = (id) => {
		return fetch(`${process.env.REACT_APP_API_URL}/api/messages/conversations/query?userId=${id}`, requestOptions)
			.then(handleResponse)
			.catch(() =>
				enqueueSnackbar("Could not load chats", {
					variant: "error",
...
export function useSendConversationMessage() {
	...
	const sendConversationMessage = (id, body) => {
		...
		return fetch(`${process.env.REACT_APP_API_URL}/api/messages/`, requestOptions)
			.then(handleResponse)
			.catch((err) => {
				console.log(err);
				enqueueSnackbar("Could send message", {
